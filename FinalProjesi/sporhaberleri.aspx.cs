...
{
    public partial class sporhaberleri : System.Web.UI.Page
    {
        ...
        void vericek()
        {
            string seckomut = "Select * from sporhaberleri  where  haberturu='Spor Haberleri' and spordurum='onaylandı' ORDER BY tarih Desc";
            ds.Clear();
